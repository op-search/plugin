...
ts=`date +%s`
curl -X POST -d "[{\"metric\": \"h0_index\", \"endpoint\": \"$Endpoint\", \"timestamp\": $ts,\"step\": 60,\"value\": $total,\"counterType\": \"GAUGE\",\"tags\": \"h0_index=total_index\"}]" http://127.0.0.1:1988/v1/push
