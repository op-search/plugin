...
ts=`date +%s`
curl -X POST -d "[{\"metric\": \"disk_index\", \"endpoint\": \"$Endpoint\", \"timestamp\": $ts,\"step\": 60,\"value\": $disk_index,\"counterType\": \"GAUGE\",\"tags\": \"index=update\"}]" http://127.0.0.1:1988/v1/push
